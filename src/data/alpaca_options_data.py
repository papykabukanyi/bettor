...
_LOAD_TRAINING_DATASET_LIST_TIMEOUT_SEC = int(os.getenv("ALPACA_OPTIONS_LOAD_TRAINING_DATASET_LIST_TIMEOUT_SEC", "45") or "45")
_LOAD_TRAINING_DATASET_SHARD_TIMEOUT_SEC = int(os.getenv("ALPACA_OPTIONS_LOAD_TRAINING_DATASET_SHARD_TIMEOUT_SEC", "25") or "25")
...
def load_training_dataset(*, max_shards: int = 90, max_rows: int | None = None) -> pd.DataFrame:
    ...
    session added (~6 days -> a full year, ~250+ shards) means
    ...
    try:
        ...
        raw_files = _shared_hf_call(
            lambda: api.list_repo_files(repo_id=HF_ALPACA_OPTIONS_DATASET_REPO, repo_type="dataset"),
