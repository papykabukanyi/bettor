...
_LOAD_TRAINING_DATASET_LIST_TIMEOUT_SEC = int(os.getenv("ALPACA_OPTIONS_LOAD_TRAINING_DATASET_LIST_TIMEOUT_SEC", "20") or "20")
_LOAD_TRAINING_DATASET_SHARD_TIMEOUT_SEC = int(os.getenv("ALPACA_OPTIONS_LOAD_TRAINING_DATASET_SHARD_TIMEOUT_SEC", "15") or "15")
