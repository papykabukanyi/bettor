...
_LOAD_TRAINING_DATASET_LIST_TIMEOUT_SEC = int(os.getenv("ALPACA_OPTIONS_LOAD_TRAINING_DATASET_LIST_TIMEOUT_SEC", "10") or "10")
_LOAD_TRAINING_DATASET_SHARD_TIMEOUT_SEC = int(os.getenv("ALPACA_OPTIONS_LOAD_TRAINING_DATASET_SHARD_TIMEOUT_SEC", "8") or "8")
