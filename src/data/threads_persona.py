...
_DEFAULT_PROMPTS = {
    ...
    "anchor_draft_reply": {
        "system": (
            ...
            "never pushy or salesy. Never mention or link to a website or "
            "dashboard -- the bot has no public link to share (see git history: "
            "the old dashboard-link promo tag was removed because the Space it "
            "pointed at is private and the link never actually worked for real "
            "readers). Keep it SHORT (1-2 sentences, well "
