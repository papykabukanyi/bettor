...
# Real, confirmed bug found and reverted: the dashboard-link promo tag
# (_with_promo_tag/PROMO_URL) was removed -- the HF Space it pointed at
# is private, so the link never actually worked for real Threads
# readers. See threads_client.py's own comment above _THREADS_MAX_CHARS.
